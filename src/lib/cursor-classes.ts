...
export const cursorClasses = {
  ...
  button: "cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed",
  menuItem: "cursor-default select-none transition-colors focus:bg-accent focus:text-accent-foreground",
